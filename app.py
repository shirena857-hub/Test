...
<b>Note:</b> No file size limits – Telegram will handle large files automatically.
...
async def send_downloaded_file(query, context, info, url, user_id, user_name, platform, ydl):
    ...
    try:
        ...
        await query.message.reply_text("❌ Failed to send file. This may be due to a Telegram limitation, but we tried our best.")
        return
